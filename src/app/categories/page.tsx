      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
            Explore All 
            <span className="bg-gradient-to-r from-primary-600 to-accent-600 bg-clip-text text-transparent"> Categories</span>
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {categories.map((category, index) => (
            <Link
              ...
              className="group"
            >
              <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 p-6 border border-gray-100 hover:border-primary-200 h-full">
                {/* Icon */}
                <div className="flex items-center justify-between mb-4">
                  ...
                  {index < 3 && (
                    <div className="flex items-center space-x-1 text-xs text-accent-600 bg-accent-50 px-2 py-1 rounded-full">
                ...
                <div>
                  ...
                  <span className="inline-flex items-center text-primary-600 group-hover:text-primary-700 text-sm font-medium">
